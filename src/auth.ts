...
import { saveTokenData } from "./storage";
import { DeviceAuthResponse } from "./types";
import { showVerificationUI, updateUIWithTokenData } from "./ui";

export const startDeviceAuth = async (): Promise<DeviceAuthResponse | null> => {
  try {
